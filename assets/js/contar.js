...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function calcularEstadisticasSEO() {
        ...
        let stopWords;
            ...
            // Ahora tienes cargada la lista de verbos en la variable stopVerbs
            
            fetch('https://sidval.github.io/TextStats/assets/stops/words.json')
                        .then(response2 => response2.json())
                        .then(data2 => {
                                stopWords = new Set(data2.map(word => word.toLowerCase()));
            ...
            .catch(error => console.error('Error al cargar el archivo JSON de verbos:', error));
    }
